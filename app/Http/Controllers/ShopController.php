...
class ShopController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(Shop::where('user_id', $user->id)->first() == null){
            ...
            if($shop->save()){
                ...
                flash(translate('Your Lab has been created successfully!'))->success();
    ...
    public function update(Request $request, $id)
    {
        ...
        if($shop->save()){
            flash(translate('Your Lab has been updated successfully!'))->success();
            return back();
        }
    ...
    public function verify_form_store(Request $request)
    {
        ...
        if($seller->save()){
            flash(translate('Your Lab verification request has been submitted successfully!'))->success();
