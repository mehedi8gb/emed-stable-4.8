...
<div class="row">
    <div class="col-lg-12 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('generic.store') }}" method="POST" enctype="multipart/form-data">
                	@csrf
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Name:')}}<span class="text-danger">*</span></label>

                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('Generic Name')}}" onkeyup="makeSlug(this.value)" id="title" name="name" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="" name="description" >{{old('description')}}</textarea>
                            @error('description')
