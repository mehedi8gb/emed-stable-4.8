            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="sm">{{translate('Name')}}</th>
                        <th data-breakpoints="sm">{{translate('Total Stock')}}</th>
                        <th data-breakpoints="md">{{translate('Generic')}}</th>
                        ...
                        <th data-breakpoints="md">{{translate('Todays Deal')}}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row gutters-5 w-150px w-md-200px mw-70">
                                <div class="col-auto">
@if ($product->thumbnail_img == null)
<span style="    height: 25px;
width: 25px;" class="avatar avatar-square avatar-xs">
    <img src="{{ uploaded_asset($product->minor->icon) }}" alt="{{translate('icon')}}">
</span>
@else
...
@endif
                        ...
                        <td>
                           {{-- <a href="{{route('products.brand',$product->brand->brand_slug)}}" target="_blank" rel="noopener noreferrer"> {{ $product->brand->name }}</a> --}}
                           {{ $product->brand->name }}
                        </td>
