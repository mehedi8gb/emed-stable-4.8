        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                <li class="aiz-side-nav-item">
                 ...
                 <li class="aiz-side-nav-item">
                     ...
                     <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('account.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['account.index'])}}">
                                <span class="aiz-side-nav-text">{{ translate('Account Management') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('sellers.payment_histories') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Seller Payouts') }}</span>
                        </a>
                    </li>
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('withdraw_requests_all') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Seller Payout Requests') }}</span>
                        </a>
                    </li>
                    <li class="aiz-side-nav-item">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <div>
                         ...
                         <li class="aiz-side-nav-item">
                             <a href="{{route('minor.group.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['minor.group.index'])}}">
                                 <span class="aiz-side-nav-text">{{translate('Minor_Group')}}</span>
                             </a>
                         </li>
                         <li class="aiz-side-nav-item">
                             <a href="{{route('generic.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['generic.index'])}}">
                                 <span class="aiz-side-nav-text">{{translate('Generic')}}</span>
                             </a>
                         </li>
                         <li class="aiz-side-nav-item">
             ...
             @endif
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('requisition.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['requisition.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Purchase Requisition') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('product_bulk_upload.index') }}" class="aiz-side-nav-link" >
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('categories.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['categories.index', 'categories.create', 'categories.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Mejor Group')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('minor.group.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['minor.group.index'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Minor Group')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('generic.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['generic.index'])}}">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('brands.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['brands.index', 'brands.create', 'brands.edit'])}}" >
                                    <span class="aiz-side-nav-text">{{translate('Company')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('attributes.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['attributes.index','attributes.create','attributes.edit'])}}">
                ...
                @endphp
                <li class="aiz-side-nav-item">
                    <a href="{{ route('prescriptions') }}" class="aiz-side-nav-link {{ areActiveRoutes(['prescription'])}}">
                        <i class="las la-folder-open aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Prescriptions') }}</span>
                        @if($prescriptions_count > 0)<span class="badge badge-info">{{ $prescriptions_count }}</span>@endif
                    </a>
                </li>
                @endif
                @if(Auth::user()->user_type == 'admin' || in_array('22', json_decode(Auth::user()->staff->role->permissions)))
                          ...
                          @if(Auth::user()->user_type == 'admin' || in_array('12', json_decode(Auth::user()->staff->role->permissions)))
                              <li class="aiz-side-nav-item">
                                  <a href="{{ route('conversations.admin_index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['conversations.admin_index', 'conversations.admin_show'])}}">
                                      <span class="aiz-side-nav-text">{{translate('Patient Messages')}}</span>
                ...
                @endif
                  ...
                  <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('job.application.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Applications')}}</span>
                            </a>
                        </li>
                    </ul>
                </li>
