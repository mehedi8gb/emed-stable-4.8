...
<div class="row">
	<div class="col-xl-10 mx-auto">
		...
		{{-- Home Banner 2 For Mobile--}}
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home Banner For Mobile (Max 3)') }}</h6>
			</div>
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
        	...
        	{{-- Home Banner For Pc 3 --}}
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home Banner For Pc (Max 3)') }}</h6>
			</div>
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
