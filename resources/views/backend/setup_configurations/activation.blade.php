...
<div class="row">
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header">
            	<h5 class="mb-0 h6 text-center">{{translate('Compare Option Activation')}}</h5>
            </div>
            <div class="card-body text-center">
                <label class="aiz-switch aiz-switch-success mb-0">
                    <input type="checkbox" onchange="updateSettings(this, 'compare_option')" @if(get_setting('compare_option') == '1') checked @endif>
                    <span class="slider round"></span>
                </label>
            </div>
        </div>
    ...
    {{-- <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <label class="aiz-switch aiz-switch-success mb-0">
                    <input type="checkbox" onchange="updateSettings(this, 'maintenance_mode')" @if(get_setting('maintenance_mode') == 1) echo "checked";?>>
                    <span class="slider round"></span>
                </label>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <label class="aiz-switch aiz-switch-success mb-0">
                    <input type="checkbox" onchange="updateSettings(this, 'disable_image_optimization')"@if(get_setting('disable_image_optimization') == 1) "checked" @endif>
                    <span class="slider round"></span>
                </label>
            </div>
        </div>
