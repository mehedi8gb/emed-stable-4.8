                ...
                <table class="table aiz-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="javascript:void(0)" class="btn btn-soft-info btn-icon btn-circle btn-sm" onclick="show_purchase_history_details({{ $cancel_request->id }})" title="{{ translate('Order Details') }}">
