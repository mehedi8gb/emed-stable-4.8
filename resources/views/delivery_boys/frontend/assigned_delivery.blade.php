...
@section('panel_content')
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{ translate('Assigned Delivery History') }}</h5>
        </div>

        @if (count($assigned_deliveries) > 0)
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input onchange="update_status()" id="update_delivery_status" value="{{ $delivery->id }}" type="checkbox">
...
(function($) {
        ...
        function update_status(selectObject) {
            var order_id = $('#update_delivery_status').val();
