...
@section('panel_content')
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{ translate('Pickup Delivery History') }}</h5>
        </div>
        @if (count($pickup_deliveries) > 0)
            <div class="card-body">
                <script>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input onclick="update_status()" id="update_delivery_status" value="{{ $delivery->id }}" type="checkbox">
