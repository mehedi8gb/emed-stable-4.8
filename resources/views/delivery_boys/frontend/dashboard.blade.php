...
@php 
$delivery_boy_info = \App\DeliveryBoy::where('user_id', Auth::user()->id)->first();
@endphp
    ...
    <div class="col-md-3">
        <div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
            <div class="px-3 pt-3 text-center">
                ...
                @php 
                $total_complete_delivery = \App\Order::where('assign_delivery_boy', Auth::user()->id)
    ...
    <div class="col-md-3">
        <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
            <div class="px-3 pt-3 text-center">
                ...
                @php 
                $total_pending_delivery = \App\Order::where('assign_delivery_boy', Auth::user()->id)
                                            ->where('delivery_status', '!=', 'delivered')
