...
@section('meta')
    ...
    {{-- <link rel="stylesheet" href="https://medex.com.bd/frontend/css/morph-1027.css"> --}}
    <style>
.ac-header {
    font-family: "Bahnschrift Regular",sans-serif;
    background: rgba(54,76,99,.25);
    color: #334e52;
    padding: 8px;
    font-size: 19px;
}
            ...
            <div class="bg-white shadow-sm rounded p-5">
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            <h1 class="mb-3 fs-26 fw-600">
                                <span style="height: 32px" class="avatar avatar-square avatar-xs">
                                    <img src="{{ uploaded_asset($detailedProduct->minor->icon) }}" alt="{{translate('icon')}}">
                                </span>
                                {{ $detailedProduct->getTranslation('name') }}
                                @if($detailedProduct->item_strength != null)
                                <span style="font-size: 16px" class="opacity-70">{{ $detailedProduct->item_strength }} &nbsp;&nbsp;&nbsp;<span style="color: blue"> {{ $detailedProduct->minor->name }} </span></span>
                            @endif
                            </h1>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12">
                                   ...
                                   @if ($detailedProduct->review_status == 1)
                                   <span class="rating">
                                    {{ renderStarRating($detailedProduct->rating) }}
                                </span>
                                <span class="ml-3 opacity-70">({{ $total }} {{ translate('reviews')}})</span>
                                   @endif
                                ...
                                <div class="col-auto ml">
                                    <small class="mr-2 opacity-70">{{ translate('Estimate Shipping Time')}}: </small>{{ $detailedProduct->est_shipping_days }} {{  translate('Days') }}
                                </div>
                                @endif

                            </div>
                            @if ($detailedProduct->generic->name)
                            <div >

                                <small style="font-size: 15px" class="mr-2 opacity-80">{{ translate('Generic Name')}}:&nbsp;</small><span class="h7 opacity-73 fw-700"><a href="{{url('generic', $detailedProduct->generic->slug).'/'.$detailedProduct->generic->id}}" target="_blank">{{ $detailedProduct->generic->name }}</a></span>
                        ...
                        <br>
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <small class="mr-2 opacity-70">{{ translate('Company')}}: </small><br>
                                    {{-- @if ($detailedProduct->added_by == 'seller' && get_setting('vendor_system_activation') == 1)
                                        <span class="text-reset">{{ $detailedProduct->user->shop->name }}</span>
                                    @else
                         ...
                         @if(home_price($detailedProduct) != home_discounted_price($detailedProduct))
                                ...
                                <div class="row no-gutters mt-3">
                                    <div class="col-sm-2">
                                        <div class="opacity-70 my-2">{{ translate('Price')}}:</div>
                                    </div>
                                    <div class="col-sm-9">
                                        <div class="fs-10 opacity-70">
                                            <del>
                                ...
                                <div class="row no-gutters my-2">
                                    <div class="col-sm-2">
                                        <div class="opacity-70">{{ translate('Discount Price')}}:</div>
                                    </div>
                                    <div class="col-sm-10">
                                        <div class="">
                            ...
                            @else
                                <div class="row no-gutters mt-3">
                                    <div class="col-sm-2">
                                        <div class="opacity-70 my-2">{{ translate('Unit Price')}}:</div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="">
                                            ...
                                            @if($detailedProduct->unit != null)
                                                <span class="h7 opacity-70">/{{ $detailedProduct->getTranslation('unit') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                        @endif
                                ...
                                <div class="opacity-70 my-2">{{ translate('Selling Unit')}}:   <span class="h5 opacity-90 fw-700">&nbsp;{{ $detailedProduct->selling_unit }}</span></div>
                            ...
                            <form id="option-choice-form">
                                ...
                                {{-- <div class="" style="margin-top: 30px;">
                                  ...
                                  <div class="radio-item_wrap row">
                                        <div class="radio-item_left col-lg-6 col-md-6 col-sm-9 col-8"><label class="cus-radio radio-label-text"><input type="radio" name="radio" value="1">1 piece<span class="checkmark"></span></label></div>
                                         <div class="radio-item_right pl-0  col-lg-6 col-md-6 col-sm-3 col-4">
                                             <div class="qty-control-button"><span class="decrement-button fa  "></span>
                                                <input class="qyt-input" type="number" min="0" maxlength="4" value="0">
                                                <span class="decrement-button plus-btn fa"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="radio-item_wrap row">
                                        <div class="radio-item_left col-lg-6 col-md-6 col-sm-9 col-8">
                                            <label class="cus-radio radio-label-text">
                                                <input type="radio" name="radio" value="1">1 Strip = 10 Pcs<span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="radio-item_right pl-0  col-lg-6 col-md-6 col-sm-3 col-4">
                                            <div class="qty-control-button"><span class="decrement-button fa  "></span><input class="qyt-input" type="number" min="0" maxlength="4" value="0"><span class="decrement-button plus-btn fa"></span></div>
                                        </div>
                                    </div>
                                    <div class="radio-item_wrap row">
                                        <div class="radio-item_left col-lg-6 col-md-6 col-sm-9 col-8">
                                            <label class="cus-radio radio-label-text">
                                                ...
                                                <span class="checkmark">1 Box = 5 Strips</span>
                                            </label>
                                        </div>
                                        <div class="radio-item_right pl-0  col-lg-6 col-md-6 col-sm-3 col-4">
                                            <div class="qty-control-button"><span class="decrement-button fa  "></span><input class="qyt-input" type="number" min="0" maxlength="4" value="0"><span class="decrement-button plus-btn fa"></span></div>
                                ...
                                <div class="row no-gutters">
                                    <div class="col-sm-2">
                                        <div class="opacity-50 my-2">{{ translate('Unit')}}:</div>
                                    </div>
                                    <div class="col-sm-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="width: 130px;">
                                                <button class="btn col-auto btn-icon btn-sm btn-circle btn-light" type="button" data-type="minus" data-field="quantity" disabled="">
                                                    ...
                                                    font-size: 1.4rem;
                                                    margin-left: 0px;
                                                    margin-top: -2px;" class="fal fa-minus"></i>
                                                </button>
                                    ...
                                    <input type="number"  name="qtys" class="col border-0 text-center flex-grow-1 fs-16 input-number" value="{{ $detailedProduct->min_qty }}" min="{{ $detailedProduct->min_qty }}" max="1000">
                                                <button class="btn  col-auto btn-icon btn-sm btn-circle btn-light" type="button" data-type="plus" data-field="quantity">
                                                    <i style="
                                                    font-size: 1.4rem;
                                                    margin-left: 0px;
                                                    margin-top: -2px;" class="fal fa-plus"></i>
                                                </button>
                                            </div>
                                            @php
                                                $qty = 0;
                    ...
                    <div class="row no-gutters">
                        <div class="col-sm-2">
                            <div class="opacity-50 my-2">{{ translate('Strip')}}: </div>
                        </div>
                            <div class="col-sm-10">
                                <div class="product-quantity d-flex align-items-center">
                                    <div class="row no-gutters align-items-center strip-plus-minus mr-3" style="width: 130px;">
                                        <button class="btn col-auto btn-icon btn-sm btn-circle btn-light" type="button" data-type="Sminus" data-field="quantity" disabled="">
                                            <i style="
                                            font-size: 1.4rem;
                                            margin-left: 0px;
                                            margin-top: -2px;" class="fal fa-minus"></i>
                                        ...
                                        <input type="text" name="quantity" class="input col border-0 text-center flex-grow-1 fs-16 input-number" placeholder="1" value="{{ $detailedProduct->min_qty }}" min="{{ $detailedProduct->min_qty }}" max="1000">
                                        <input type="number"  name="strips" class="col border-0 text-center flex-grow-1 fs-16" value="{{ $detailedProduct->min_qty }}" min="{{ $detailedProduct->min_qty }}" max="1000">
                                        <button class="btn  col-auto btn-icon btn-sm btn-circle btn-light" type="button" data-type="Splus" data-field="quantity">
                                            <i style="
                                            font-size: 1.4rem;
                                            margin-left: 0px;
                                            margin-top: -2px;" class="fal fa-plus"></i>
                                        </button>
                                        <input type="hidden" name="strip_size"  value="{{ $detailedProduct->strip_size }}">
                                    </div>
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col-sm-2">
                            <div class="opacity-50 my-2">{{ translate('Boxs')}}: </div>
                        </div>
                            <div class="col-sm-10">
                                <div class="product-quantity d-flex align-items-center">
                                    <div class="row no-gutters align-items-center box-plus-minus mr-3" style="width: 130px;">
                                        <button class="btn col-auto btn-icon btn-sm btn-circle btn-light" type="button" data-type="Bminus" data-field="quantity" disabled="">
                                            <i style="
                                            font-size: 1.4rem;
                                            margin-left: 0px;
                                            margin-top: -2px;" class="fal fa-minus"></i>
                                        ...
                                        <input type="text" name="quantity" class="input col border-0 text-center flex-grow-1 fs-16 input-number" placeholder="1" value="{{ $detailedProduct->min_qty }}" min="{{ $detailedProduct->min_qty }}" max="1000">
                                        <input type="number"  name="boxs" class="col border-0 text-center flex-grow-1 fs-16" value="{{ $detailedProduct->min_qty }}" min="{{ $detailedProduct->min_qty }}" max="10000">
                                        <button class="btn  col-auto btn-icon btn-sm btn-circle btn-light" type="button" data-type="Bplus" data-field="quantity">
                                            <i style="
                                            font-size: 1.4rem;
                                            margin-left: 0px;
                                            margin-top: -2px;" class="fal fa-plus"></i>
                                        </button>
                                        <input type="hidden" name="box_size"  value="{{ $detailedProduct->box_size }}">
                                    </div>
                                </div>
                            </div>
                    </div>
                                ...
                                <div class="row no-gutters pb-3 " id="chosen_price_div">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="opacity-50 my-2">{{ translate('Total Units')}}:</div>
                                    </div>
                                    <div class="col-sm-10">
...
{{--
                                <button class="bubbly-button mr-2" onclick="addToCart()">   <i class="la la-shopping-cart la-1x"></i>
                                    <span class="d-none d-md-inline-block">{{ translate('Add to cart')}}</span></i></button> --}}

                                <button type="button" class="btn btn-soft-primary mr-2 add-to-cart fw-600" onclick="addToCart()">
                                    <i class="las la-shopping-bag"></i>
                                    <span class="d-none d-md-inline-block"> {{ translate('Add to cart')}}</span>
                                    <span class="d-none d-xs-inline-block"> {{ translate('Add to cart')}}</span>
                                </button>

                                {{-- <button class="glow-on-hover"  onclick="buyNow()" type="button"><i class="las la-shopping-bag la-1x"></i>
                                    <span class="d-none d-md-block">{{ translate('Buy')}}</span>
                                    <span class="d-none d-sm-block d-md-none"> {{ translate('Buy Now')}}</span> </button> --}}
...
bubblyButtons[i].addEventListener('click', animateButton, false);
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    ...
                                    <button type="button" class="btn btn-outline-info mr-2 add-to-cart fw-600" onclick="addToWishList({{ $detailedProduct->id }})">

                                        <span class="d-xl-none d-md-none d-lg-block">{{ translate('wishlist')}}</span>
                                        <span class="d-none d-md-inline-block"> {{ translate('Add to wishlist')}}</span>
                                    </button>
                                    <!-- Add to compare button -->
                                    <button type="button" class="btn btn-outline-primary mr-2 add-to-cart fw-600" onclick="addToCompare({{ $detailedProduct->id }})">

                                        <span class="d-xl-none d-md-none d-lg-block">{{ translate('compare')}}</span>
                                        <span class="d-none d-md-inline-block"> {{ translate('alternative brand')}}</span>
                                    </button>
                ...
                <div class="col-xl-3 order-1 order-xl-0">
                    <div class="bg-white shadow-sm mb-3">
                        <div class="position-relative p-3 text-left">
                            ...
                            @if($detailedProduct->added_by == 'seller' && get_setting('vendor_system_activation') == 1)
                                <a href="{{ route('lab.visit', $detailedProduct->user->shop->slug) }}" class="text-reset d-block fw-600">
                        ...
                        @if($detailedProduct->added_by == 'seller' && get_setting('vendor_system_activation') == 1)
                            <div class="row no-gutters align-items-center border-top">
                                <div class="col">
                                    <a href="{{ route('lab.visit', $detailedProduct->user->shop->slug) }}" class="d-block btn btn-soft-primary rounded-0">{{ translate('Visit Store')}}</a>
                                </div>
                                <div class="col">
                            ...
                            <div class="tab-pane fade active show" id="tab_default_1">
                                <div class="p-4">
                                    <div class="mw-100 overflow-hidden text-left aiz-editor-data">
                                        ...
                                        {!! $detailedProduct->generic->description !!}
