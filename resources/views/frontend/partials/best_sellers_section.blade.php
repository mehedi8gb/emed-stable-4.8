                        ...
                        @if ($count < 20)
                            ...
                            <div class="carousel-box">
                                <div class="row no-gutters box-3 align-items-center border border-light rounded hov-shadow-md my-2 has-transition">
                                    <div class="col-4">
                                        <a href="{{ route('lab.visit', $seller->user->shop->slug) }}" class="d-block p-3">
                                            <img
                                    ...
                                    <div class="col-8 border-left border-light">
                                        <div class="p-3 text-left">
                                            <h2 class="h6 fw-600 text-truncate">
                                                <a href="{{ route('lab.visit', $seller->user->shop->slug) }}" class="text-reset">{{ $seller->user->shop->name }}</a>
                                            </h2>
                                            ...
                                            <a href="{{ route('lab.visit', $seller->user->shop->slug) }}" class="btn btn-soft-primary btn-sm">
