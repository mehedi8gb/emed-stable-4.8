...
<head>
    ...
    <!-- FontAwesome kit -->
    <script src="https://kit.fontawesome.com/10cf1b9749.js" ></script>

    <!-- Bangla FONT -->
    <link href="https://fonts.maateen.me/bangla/font.css" rel="stylesheet">
    <!-- CSS Files -->
    <link rel="stylesheet" crossorigin="anonymous" href="{{ static_asset('assets/css/vendors.css') }}">
  <!-- CUSTOM CSS START -->
    @stack('css')
  <!-- CUSTOM CSS END -->

    @if(\App\Language::where('code', Session::get('locale', Config::get('app.locale')))->first()->rtl == 1)
    <link rel="stylesheet" crossorigin="anonymous" href="{{ static_asset('assets/css/bootstrap-rtl.min.css') }}">
    @endif
    <link rel="stylesheet" crossorigin="anonymous" href="{{ static_asset('assets/css/aiz-core.css') }}">
    <link rel="stylesheet" crossorigin="anonymous" href="{{ static_asset('assets/css/custom-style.css') }}">
...
@import url('https://fonts.googleapis.com/css2?family=Sora:wght@100;200;300;400;500;600;700;800&display=swap');
    ...
    <style>
        body{
            font-family: 'Open Sans', sans-serif, 'Bangla';
    ...
    @php
      $langs =  \App\Language::where('code', Session::get('locale', Config::get('app.locale')))->first()->code == 'bd';
    @endphp

    @if($langs)
  <style>
      body{
          font-family: 'Bangla', 'Open Sans', sans-serif !important;
          /* font-size: 18px; */
      }
  </style>
    @endif
...
<body >
    <!-- aiz-main-wrapper -->
    <div style="min-height: 0vh !important;" class="aiz-main-wrapper d-flex flex-column">
        ...
        <div style="margin-top: 105px">
            ...
            @else <div style="margin-top: 100px">
...
// Cart Modal Quantity calculation
