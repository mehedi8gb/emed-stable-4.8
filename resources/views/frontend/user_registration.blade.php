                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{  translate('Password') }}" name="password" id="confirm">
                                            <span toggle="#confirm"  class="fad fa-eye-slash fa-md field-icon toggle-password"></span>
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control" placeholder="{{  translate('Confirm Password') }}" id="password" name="password_confirmation">
                                            <span toggle="#password"  class="fad fa-eye-slash fa-md field-icon toggle-password"></span>
                                        </div>
