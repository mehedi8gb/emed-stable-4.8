<form class="form-default" role="form" action="{{ route('education.update', $address_data->id) }}" method="POST">
    @csrf
    <div class="p-3">
        <div class="row">
            <div class="col-md-2">
            ...
            <div class="col-md-10">
                <textarea class="form-control mb-3" placeholder="{{ translate('Your Address')}}" rows="2" name="address" required>{{ $address_data->degree }}</textarea>
            </div>
        </div>
        {{-- <div class="row">
            <div class="col-md-2">
