...
@section('panel_content')
    <div class="aiz-titlebar mt-2 mb-4">
      <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{ translate('Your Lab') }}</h1>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-4 mx-auto mb-3" >
            <a href="{{ route('seller.digitalproducts.upload')}}">
              <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                  ...
                  <div class="fs-18 text-primary">{{ translate('Update Your Lab Tests') }}</div>
              </div>
            </a>
        </div>
        <div class="col-md-4 mx-auto mb-3" >
            <a href="{{ route('lab.index')}}">
              <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                  <span class="size-60px rounded-circle mx-auto bg-secondary d-flex align-items-center justify-content-center mb-3">
                      <i class="fad fa-cogs la-3x text-white"></i>
                  </span>
                  <div class="fs-18 text-primary">{{ translate('Setup Your Lab') }}</div>
              </div>
            </a>
        </div>
