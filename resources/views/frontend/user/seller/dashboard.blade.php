    ...
    <div class="row">
      ...
      <div class="col-md-4">
          ...
          <div class="bg-white mt-4 p-4 text-center">
              <div class="h5 fw-600">{{ translate('Lab')}}</div>
              <p>{{ translate('Manage & organize your Lab')}}</p>
              <a href="{{ route('lab.index') }}" class="btn btn-soft-primary">{{ translate('Go to setting')}}</a>
          </div>
          <div class="bg-white mt-4 p-4 text-center">
