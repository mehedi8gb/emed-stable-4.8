    ...
    <div class="row gutters-10 justify-content-center">
        ...
        <div class="col-md-4 mx-auto mb-3" >
            <a href="{{ route('seller.products.add')}}">
              <div class="p-5 rounded  c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                  <span style="height: 43px; width: 43px" class=" rounded-circle mx-auto bg-secondary d-flex align-items-center justify-content-center mb-3">
                      <i class="las la-plus la-3x text-white"></i>
                  </span>
                  <div class="fs-18 text-primary">{{ translate('Add Product') }}</div>
              </div>
            </a>
        </div>
        <div class="col-md-4 mx-auto mb-3" >
            <a href="{{ route('seller.products.upload')}}">
              <div class="p-5 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                  <span style="height: 43px; width: 43px" class="rounded-circle mx-auto bg-secondary d-flex align-items-center justify-content-center mb-3">
                      <i class="las la-plus la-3x text-white"></i>
                  </span>
                  <div class="fs-18 text-primary">{{ translate('Add Missing Product') }}</div>
              </div>
            </a>
        </div>
