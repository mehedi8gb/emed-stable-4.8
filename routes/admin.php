...
//minor group
    Route::get('/minor-group', 'MinorGroupController@index')->name('minor.group.index');
    Route::get('/minor-group/create', 'MinorGroupController@create')->name('minor.group.create');
    Route::get('/minor-group/edit/{id}', 'MinorGroupController@edit')->name('minor_group.edit');
    Route::get('/minor-group/distroy/{id}', 'MinorGroupController@destroy')->name('minor_group.destroy');
    Route::post('/minor-group/store', 'MinorGroupController@store')->name('minor.group.store');
    Route::post('/minor-group/update/{id}', 'MinorGroupController@update')->name('minor.group.update');
...
//Generic section
    ...
    Route::get('/generic/edit/{id}', 'GenericController@edit')->name('generic.edit');
    Route::post('/generic/update/{id}', 'GenericController@update')->name('generic.update');
    Route::get('/generic/delate/{id}', 'GenericController@destroy')->name('generic.destroy');
    // Route::get('/minor-group/edit/{id}', 'GenericController@@edit')->name('minor_group.edit');
    // Route::get('/minor-group/distroy/{id}', 'GenericController@@distroy')->name('minor_group.distroy');

    //Prescription page
  Route::group(['prefix' => 'prescription'], function(){
    Route::get('/', 'PrescriptionController@index')->name('prescriptions');
    Route::get('/add', 'PrescriptionController@create')->name('prescriptions.add');
    Route::post('/store', 'PrescriptionController@store')->name('prescriptions.store');
    Route::get('/delate/{id}', 'PrescriptionController@destroy')->name('prescriptions.destroy');
    Route::post('/update/{id}', 'PrescriptionController@update')->name('prescriptions.update');
    Route::post('/proceed/{id}', 'PrescriptionController@proceed')->name('prescriptions.proceed');
    Route::post('/messageSend', 'PrescriptionController@sendMsg')->name('pres.message.to');
...
Route::prefix('requisition')->group(function () {
    Route::get('/index', 'RequisitionController@index')->name('requisition.index');
    Route::get('/create', 'RequisitionController@create')->name('requisition.create');
    ...
    Route::prefix('job')->group(function () {
        ...
        Route::prefix('circuler')->group(function () {
        Route::get('/', 'JobController@ApplicationIndex')->name('job.application.index');
        Route::get('/applications/{id}/{slug}', 'JobController@MainApplicationShow')->name('main.application.show');
        Route::get('/application/show/{id}', 'JobController@ApplicationShow')->name('application.show');
        Route::get('/application/delete/{id}', 'JobController@applicationDestroy')->name('application.destroy');
        Route::post('/status-update', 'JobController@update_app_status')->name('application.update_status');
        });
    });

    // Account Management
    Route::prefix('account-management')->group(function(){
        Route::get('/', 'AccountManagementController@index')->name('account.index');
    });
});
